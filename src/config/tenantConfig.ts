...
export const LOCALITO_TABLE_LOCATIONS: TableLocation[] = [
  ...
  { id: 1, label: 'Mesa 1', shortLabel: '#1' },
  { id: 2, label: 'Mesa 2', shortLabel: '#2' },
  { id: 3, label: 'Mesa 3', shortLabel: '#3' },
  { id: 4, label: 'Mesa 4', shortLabel: '#4' },
  { id: 5, label: 'Mesa 5', shortLabel: '#5' },
  { id: 6, label: 'Mesa 6', shortLabel: '#6' },
  { id: 7, label: 'Mesa 7', shortLabel: '#7' },
  { id: 8, label: 'Mesa 8', shortLabel: '#8' },
